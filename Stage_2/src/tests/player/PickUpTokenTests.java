...
public class PickUpTokenTests {
	...
	public void test08() {
		...
		AbstractTile tt = t.getTile();
		gb.toggleNextPlayer();
		boolean s_expect = true;
		boolean s_actual = gb.save("save");
		assertTrue("",s_expect && s_actual && expected==actual && expectedVal==actualVal && expectedName.equals(actualName) && pt==tt);	
	}
